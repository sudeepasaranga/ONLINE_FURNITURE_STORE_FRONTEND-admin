...
const ReportGen11 = Feedback =>{

    const doc = new jsPDF();
    const tableColumn = ["Username","Date","Ratings", "Feedback", "Suggestions"];
    const tableRows = [];
    ...
    doc.text('All Feedbacks - Report', 14, 50, 'left');
    ...
    doc.save(`Feedbacks_${year}`+" "+`${month}`+" "+`${day}`+".pdf");

}

export default ReportGen11;